...
export default class ProfileView extends React.Component {
  ...
  getUser() {
    ...
    axios
      .get(`https://szwedshop-moviedb.herokuapp.com/users/${username}`, {
  ...
  removeFavorite(e, movie) {
    ...
    axios
      .delete(`https://szwedshop-moviedb.herokuapp.com/users/${username}/movies/${movie}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
  ...
  handleUpdate(e, newUsername, newPassword, newEmail, newBirthday) {
    ...
    axios({
      method: 'put',
      url: `https://szwedshop-moviedb.herokuapp.com/users/${username}`,
      headers: { Authorization: `Bearer ${token}` },
      data: {
  ...
  handleDeregister(e) {
    ...
    axios
      .delete(`https://szwedshop-moviedb.herokuapp.com/users/${username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
